...
class WishListController extends Controller
{
  ...
  public function list()
  {
    ...
    $wishList = WishList::orderBy('dateend','asc')->join('auction', 'auction.auction_id', '=','wishlist.auction_id')->join('owner', 'owner.id_auction', '=', 'wishlist.auction_id')->join('users', 'users.user_id', '=', 'owner.id_user')->get();
