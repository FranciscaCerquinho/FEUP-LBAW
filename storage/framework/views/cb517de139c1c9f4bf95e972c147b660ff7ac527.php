...
<?php if($num_endAuctions>0): ?>
  <div class="row endAuctions container-fluid align-items-center" id="newAuctions">
  <?php for($i = 0; $i < $num_endAuctions; $i++) {?>
    <div class="endAuctionAlert" data-id='<?php echo e($endAuctions[$i]->endauction_id); ?>'>
      <div class="alert alert-info alert-dismissable" role="alert">
        <a class="panel-close close" data-dismiss="alert">x</a>
        The Auction <?php echo e($endAuctions[$i]->name); ?> has been sell! Contact the user <?php echo e($buyers[$i]->contact); ?>    &nbsp   &nbsp
...
<?php echo $__env->make('layouts.main',['type'=>$type], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>