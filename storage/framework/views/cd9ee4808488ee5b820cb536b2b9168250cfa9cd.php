    ...
    <div class="row">
        ...
        <?php if($errors->has('dateEnd')): ?>
            <div class="alert alert-danger alert-dismissable" role="alert">
                <a class="panel-close close" data-dismiss="alert">x</a>
                <i class="fas fa-bell"></i>
                <?php echo e($errors->first('dateEnd')); ?>
        ...
        <?php if($errors->has('buyNow')): ?>
            <div class="alert alert-danger alert-dismissable" role="alert">
                <a class="panel-close close" data-dismiss="alert">x</a>
                <i class="fas fa-bell"></i>
                <?php echo e($errors->first('buyNow')); ?>

            </div>
        <?php endif; ?>
        <form id="taskForm" action="<?php echo e(route('addAuction')); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
