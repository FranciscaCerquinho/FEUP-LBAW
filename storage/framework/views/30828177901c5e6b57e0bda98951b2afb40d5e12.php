<?php $__env->startSection('title', 'Auction'); ?>
...
<div class="container" id="item" data-id="<?php echo e($auction->auction_id); ?>">
		...
		<div class="col-lg-12" style="margin-top:30px;">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page"><?php echo e($auction->name); ?></li>
				</ol>
			</nav>
		</div>
	<!-- Left Column / Headphones Image -->
	<div class="col-lg-6">
		<img  class="active product_image" src="/images/<?php echo e($auction->auctionphoto); ?>" alt="auction" >
		 <!-- Cable Configuration -->
		 
		 <div class="cable-config">
			<div class="cable-choose">
				<button  id="likeButton" <?php if($like==1): ?> style="border: 2px solid #86939E; outline: none;" <?php endif; ?>>
					<span class="far fa-thumbs-up" id="like_hand"></span>
					<span id="likeAuction"><?php echo e($auction->auction_like); ?> </span>
				</button>
				<button  id="unlikeButton"  <?php if($like==2): ?> style="border: 2px solid #86939E; outline: none;"<?php endif; ?>>
					<span class="far fa-thumbs-down" id="unlike_hand" ></span>
					<span id="unlikeAuction" ><?php echo e($auction->auction_dislike); ?></span>
				</button>
				<?php if($type==1): ?>
				<button id="addToWishList" <?php if($wishList==1): ?> style="border: 2px solid #86939E; outline: none;"<?php endif; ?>>
					<span class="fas fa-shopping-cart"  ></span>&nbsp;  
					<strong>Wish List</strong>
				</button>
				<button  data-popup-reportAuction-open="popup-1" type="button"  class="buttonReport" <?php if($auctionReported==1): ?> style="border: 2px solid #86939E; outline: none;"<?php endif; ?>><span class="reportAuctionButton fas fa-bullhorn"></span> &nbsp; Report</button>
  ...
  <div  class="col-lg-6">
    ...
    <div class="product-description">
	  ...
	  <span class="time_left" ><script>SplitDate("<?php echo e($auction->dateend); ?>",1);</script> left</span>
    </div>
    ...
    <div class="product-configuration">
      ...
      <div class="product-style row col-12">
		...
		<div class="col-sm-8 user_information" >
			<a class="owner_name" href="<?php echo e(route('ownerProfile', ['id'=>$auction->user_id])); ?>"><?php echo e($auction->firstname); ?> <?php echo e($auction->lastname); ?></a>
		</div>
		</div>
	  ...
	  <div class="product-style row col-12">
		...
		<div class="col-sm-8 user_information" >
			<p class="category_name"><?php echo e($auction->category); ?></p>
		</div>
	  </div>
    ...
    <div class="product-price" id="buy_now_button">
	  <span  id ="item_price">EUR <?php echo e($auction->actualprice); ?></span>
	  <?php if($type==1): ?>
	  <button class="cart-btn" id="buyNow" >Buy Now (<?php echo e($auction->buynow); ?>€)</button>
	  <?php endif; ?>
	</div>
  ...
  <div class="container comments">
	<div class="row">
		<?php foreach($comments as $comment) {
			...
			if($j != -1)  { ?>
			<?php echo $__env->make('partials.comments',['comment'=>$comment, 'commentsLikes'=>$commentsLikes[$j], 'type' => $type], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>	<?php }
			else { ?>
			<?php echo $__env->make('partials.comments',['comment'=>$comment], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php }} ?>
		<?php if(Auth::check()): ?>
			<?php if($type==1): ?>
