				...
				<div class="col-md-9 personal-info">
					<form class="form-horizontal" role="form">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-8">
								<input class="form-control" type="number" min="14" max="17" value="{{Auth::user()->contact}}" id="example-text-input">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-md-2 control-label">Address:</label>
							<div class="col-md-8">
								<input class="form-control" type="text" value="{{Auth::user()->address}}" id="example-text-input">
							</div>
						</div>
						<div class="form-group row">
