...
We developed an online auctions, where the visitors can see the auctions and the last bid done. The visitors can also search for auctions and search by category. The user's can make bids and if they want to buy the product imediately they can use the button "Buy Now" and buy for the highest price set by the owner. The user's can report auctions by clicking on auction and click on "Report" button, under the auction image. They can also report other user's, they can report by clicking on the report button in each user comment or by clicking in Report on owner's page. The administrator can ban and unban auctions and users.
As an user you can edit your profile, see the auctions created by you and the bids you've made. 
